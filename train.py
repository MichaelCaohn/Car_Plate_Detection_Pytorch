...
# todo don't need class type
classes = load_classes(opt.class_path)

# Get data configuration
# todo modify the datapath configuration in the "config/coco.data" file
...
# Get dataloader
# todo need to add a picture converter to compatible with 416*416 size
